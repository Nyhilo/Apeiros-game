...
pixels, percent, w, h = check_square(player_image)
...
print('expected: NewPlayer got: ' + get_player(str(id)).nickname)
...
print('expected: NewPlayer got: ' + get_player('newPlayer').nickname)

printn('Does that player have a timestamp?')
print(player_b.created_at)

printn('Try changing the nickname.')
player_b.nickname = 'NewNickName'
print('expected: NewNickName got: ' + get_player('newPlayer').nickname)
